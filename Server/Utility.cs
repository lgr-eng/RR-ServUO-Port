...
#pragma warning restore 618
        ...
        {
                SkillName.Alchemy,                SkillName.Anatomy,                SkillName.Druidism,                SkillName.Mercantile,
                SkillName.ArmsLore,                SkillName.Parry,                SkillName.Begging,                SkillName.Blacksmith,
                SkillName.Bowcraft,                SkillName.Peacemaking,                SkillName.Camping,                SkillName.Carpentry,
                SkillName.Cartography,                SkillName.Cooking,                SkillName.Searching,                SkillName.Discordance,
                SkillName.Psychology,                SkillName.Healing,                SkillName.Seafaring,                SkillName.Forensics,
                SkillName.Herding,                SkillName.Hiding,                SkillName.Provocation,                SkillName.Inscribe,
                SkillName.Lockpicking,                SkillName.Magery,                SkillName.MagicResist,                SkillName.Tactics,
                SkillName.Snooping,                SkillName.Musicianship,                SkillName.Poisoning,                SkillName.Marksmanship,
                SkillName.Spiritualism,                SkillName.Stealing,                SkillName.Tailoring,                SkillName.Taming,
                SkillName.Tasting,                SkillName.Tinkering,                SkillName.Tracking,                SkillName.Veterinary,
                SkillName.Swords,                SkillName.Bludgeoning,                SkillName.Fencing,                SkillName.FistFighting,
                SkillName.Lumberjacking,                SkillName.Mining,                SkillName.Meditation,                SkillName.Stealth,
                SkillName.RemoveTrap,                SkillName.Necromancy,                SkillName.Focus,                SkillName.Knightship,
                SkillName.Bushido,                SkillName.Ninjitsu,                SkillName.Elementalism
        };

        private static readonly SkillName[] m_CombatSkills = new[]
        {SkillName.Marksmanship, SkillName.Swords, SkillName.Bludgeoning, SkillName.Fencing, SkillName.FistFighting};
