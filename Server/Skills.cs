...
namespace Server
{
    ...
    public class Skill
    {
        ...
        [CommandProperty(AccessLevel.Counselor)]
        //public double Value // removed for RRPort
        //{
        //    get
        //    {
    ...
    public class SkillInfo
    {
        ...
        private static SkillInfo[] m_Table = new SkillInfo[58]
        {
            ...
            new SkillInfo(  2, "Druidism",          0.0,    0.0,    0.0,    "Druid",    null,   0.0,    0.0,    1.0,    1.0, StatCode.Int, StatCode.Str ),
            new SkillInfo(  3, "Mercantile",        0.0,    0.0,    0.0,    "Merchant", null,   0.0,    0.0,    1.0,    1.0, StatCode.Int, StatCode.Dex),
            new SkillInfo(  4, "Arms Lore",         0.0,    0.0,    0.0,    "Man-at-arms",  null,   0.75,   0.15,   0.1,    1.0, StatCode.Int, StatCode.Str),
            ...
            new SkillInfo(  8, "Bowcrafting",       6.0,    16.0,   0.0,    "Bowyer",   null,   0.6,    1.6,    0.0,    1.0, StatCode.Dex, StatCode.Str),
            ...
            new SkillInfo( 14, "Searching",         0.0,    0.0,    0.0,    "Scout",    null,   0.0,    0.4,    0.6,    1.0, StatCode.Int, StatCode.Dex),
            new SkillInfo( 15, "Discordance",       0.0,    2.5,    2.5,    "Demoralizer",      null,   0.0,    0.25,   0.25,   1.0, StatCode.Dex, StatCode.Int, true),
            new SkillInfo( 16, "Psychology",        0.0,    0.0,    0.0,    "Scholar",  null,   0.0,    0.0,    1.0,    1.0, StatCode.Int, StatCode.Str),
            new SkillInfo( 17, "Healing",           6.0,    6.0,    8.0,    "Healer",   null,   0.6,    0.6,    0.8,    1.0, StatCode.Int, StatCode.Dex),
            new SkillInfo( 18, "Seafaring",         0.0,    0.0,    0.0,    "Sailor",   null,   0.5,    0.5,    0.0,    1.0, StatCode.Dex, StatCode.Str),
            new SkillInfo( 19, "Forensics",         0.0,    0.0,    0.0,    "Undertaker",   null,   0.0,    0.2,    0.8,    1.0, StatCode.Int, StatCode.Dex),
            new SkillInfo( 20, "Herding",           16.25,  6.25,   2.5,    "Shepherd", null,   1.625,  0.625,  0.25,   1.0, StatCode.Int, StatCode.Dex),
            new SkillInfo( 21, "Hiding",            0.0,    0.0,    0.0,    "Skulker",  null,   0.0,    0.8,    0.2,    1.0, StatCode.Dex, StatCode.Int),
            ...
            new SkillInfo( 24, "Lockpicking",       0.0,    25.0,   0.0,    "Lockpicker",   null,   0.0,    2.0,    0.0,    1.0, StatCode.Dex, StatCode.Int),
            new SkillInfo( 25, "Magery",            0.0,    0.0,    15.0,   "Wizard",       null,   0.0,    0.0,    1.5,    1.0, StatCode.Int, StatCode.Str, true),
            new SkillInfo( 26, "Magic Resistance",  0.0,    0.0,    0.0,    "Magic Warder",     null,   0.25,   0.25,   0.5,    1.0, StatCode.Str, StatCode.Dex),
            ...
            new SkillInfo( 31, "Marksmanship",      2.5,    7.5,    0.0,    "Deadeye",  null,   0.25,   0.75,   0.0,    1.0, StatCode.Dex, StatCode.Str, true),
            new SkillInfo( 32, "Spiritualism",      0.0,    0.0,    0.0,    "Spiritualist", null,   0.0,    0.0,    1.0,    1.0, StatCode.Int, StatCode.Str, false, true),
            new SkillInfo( 33, "Stealing",          0.0,    10.0,   0.0,    "Thief",    null,   0.0,    1.0,    0.0,    1.0, StatCode.Dex, StatCode.Int),
            new SkillInfo( 34, "Tailoring",         3.75,   16.25,  5.0,    "Tailor",   null,   0.38,   1.63,   0.5,    1.0, StatCode.Dex, StatCode.Int),
            new SkillInfo( 35, "Taming",            14.0,   2.0,    4.0,    "Beastmaster",  null,   1.4,    0.2,    0.4,    1.0, StatCode.Str, StatCode.Int, true),
            new SkillInfo( 36, "Tasting",           0.0,    0.0,    0.0,    "Food Taster",      null,   0.2,    0.0,    0.8,    1.0, StatCode.Int, StatCode.Str),
            ...
            new SkillInfo( 41, "Bludgeoning",       9.0,    1.0,    0.0,    "Bludgeoner",   null,   0.9,    0.1,    0.0,    1.0, StatCode.Str, StatCode.Dex, true),
            new SkillInfo( 42, "Fencing",           4.5,    5.5,    0.0,    "Fencer",   null,   0.45,   0.55,   0.0,    1.0, StatCode.Dex, StatCode.Str, true),
            new SkillInfo( 43, "Fist Fighting",     9.0,    1.0,    0.0,    "Brawler",  null,   0.9,    0.1,    0.0,    1.0, StatCode.Str, StatCode.Dex, true),
            ...
            new SkillInfo( 46, "Meditation",        0.0,    0.0,    0.0,    "Meditator",    null,   0.0,    0.0,    0.0,    1.0, StatCode.Int, StatCode.Str),
            new SkillInfo( 47, "Stealth",           0.0,    0.0,    0.0,    "Sneak",    null,   0.0,    0.0,    0.0,    1.0, StatCode.Dex, StatCode.Int),
            new SkillInfo( 48, "Remove Trap",       0.0,    0.0,    0.0,    "Trespasser",   null,   0.0,    0.0,    0.0,    1.0, StatCode.Dex, StatCode.Int),
            ...
            new SkillInfo( 51, "Knightship",        0.0,    0.0,    0.0,    "Knight",   null,   0.0,    0.0,    0.0,    1.0, StatCode.Str, StatCode.Int, true),
            ...
            new SkillInfo( 54, "Elementalism",      0.0,    0.0,    15.0,   "Elementalist", null,   0.0,    1.0,    1.0,    1.0, StatCode.Int, StatCode.Str, true),
