        ...
        */
        ...
        public override bool OnBeforeDeath()
        {
            if (!MySettings.S_GuardsSentenceDeath && (this.LastKiller is TownGuards || (this.LastKiller is BaseVendor && this.LastKiller.WhisperHue != 999 && !(this.LastKiller is PlayerVendor) && !(this.LastKiller is PlayerBarkeeper))))
            {
                ...
                if (this.RaceID > 0 && Server.Items.BaseRace.IsEvilDemonCreature(this) && world == Land.Serpent && !PlayerSettings.GetDiscovered(this, "the Serpent Island"))
                {
        ...
        public new void Damage(int amount, Mobile from)
        {
        ...
        public bool IsHarmfulCriminal(Mobile target)
        {
