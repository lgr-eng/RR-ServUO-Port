...
namespace Server.Engines.Craft
{
    public class CraftGumpItem : Gump
    {
        ...
        public void DrawItem()
        {
            ...
            else if ((typeof(ClothingQuality).IsAssignableFrom(m_CraftItem.ItemType)) ||
                (typeof(ArmorQuality).IsAssignableFrom(m_CraftItem.ItemType)) ||
                (typeof(WeaponQuality).IsAssignableFrom(m_CraftItem.ItemType)))
            {
                m_ShowExceptionalChance = true;
            }
        }
